                    ...
                    <Card className="col-sm-12 div-main-body text-center">
                        ...
                        <Card.Body>
                            <Card.Text className="row" id="questionary-container">
                                <a href="https://loja.cocacolabrasil.com.br/marca-sprite" className="mx-auto">
                                ...
                                <a href="https://www.americanas.com.br" className="mx-auto">
                                ...
                                <a href="http://www.burgerking.com.br" className="mx-auto">
